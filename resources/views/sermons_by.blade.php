@extends('base')
    @section('title', 'Predications par '.$author['preacher_name'].' | '.config('app.name'))
    @section('content')
      ...
      <div class="row">
        <div class="col-md-12">
          <ol class="breadcrumb">
            ...
            <li class="active">Predications par {{ $author['preacher_name'] }}</li>
          </ol>
        </div>
      </div>
    </div>
                    ...
                    <header class="post-title">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-9 col-sm-9">
                          ...
                          <span class="meta-data"><i class="fa fa-calendar"></i>Publié le {{ $sermon['sermon_date'] }} | {{ __('Prédicateur')}} : <a href="#">{{ $author['preacher_name'] }}</a></span> </div>
