                                ...
                                <div class="row justify-content-between">
                                    ...
                                    <div class="col-md-4">
                                        <div class="text-md-end mt-3 mt-md-0">
                                            <a type="button" class="btn btn-success waves-effect waves-light" href="{{ route('home.add_event') }}"><i class="mdi mdi-plus-circle me-1"></i> Ajouter</a>
                                        </div>
                                    </div><!-- end col-->
                                </div> <!-- end row -->
                            </div>
                ...
                <div class="row">
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            ...
                            @endforeach
                            @else 
                            <p class="text-center">Aucun evenement enregistré</p>
                            @endif
                            </tbody>
                        </table>
                    </div>
