@extends('base')
@section('title','Nos predications | '.config('app.name'))
@section('content')
    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Predications</li>
          ...
          <article class="post sermon">
            ...
            <div class="post-content">
              ...
              <div class="row">
                ...
                <div class="col-md-4"> <a href="{{ route('sermon', ['id'=> $sermon['id']]) }}" class="media-box"> <img src="sermon/{{ $sermon['sermon_cover'] }}" alt="" class="img-thumbnail"> </a> </div>
